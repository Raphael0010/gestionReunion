...
const ModalEditReunion: React.FC<Props> = ({ visible, setVisible, id }) => {
  const { Option } = Select;
      ...
      <Modal
        ...
        footer={
          <div>
            ...
            <Button type="primary" onClick={createReunion}>
              Ajouter
            </Button>
          </div>
        }
...
export default ModalEditReunion;
